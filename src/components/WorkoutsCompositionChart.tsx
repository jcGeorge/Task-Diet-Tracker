...
import type { MetaItem, WorkoutEntry } from "../types";
...
export function WorkoutsCompositionChart({ entries, workouts }: WorkoutsCompositionChartProps) {
